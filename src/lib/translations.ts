  ...
  de: {
    ...
    experience: {
      ...
      jobs: [
        ...
        {
          company: 'Sparkassenversicherung',
          role: 'Werkstudent – Python Dev',
          location: 'Mannheim',
          period: 'Feb. 2023 - Mai 2024',
          highlights: [
            'Entwicklung grafischer (GUI) Benutzeroberflächen, Automatisierung und Testfallgenerierung mit Tkinter und CustomTkinter',
            'Datenverarbeitung und Analyse mit Pandas sowie Datenbankintegration mit Oracle SQL Developer',
            'Erstellung und Durchführung von Unit-Tests zur Sicherstellung der Funktionalität und Zuverlässigkeit',
            'Einsatz von Gitea, Eclipse, Docker, Podman und Oracle Developer',
          ],
        },
        {
          company: 'Engenious',
          role: 'Werkstudent – Mobile Dev',
          location: 'Brühl',
          period: 'Mai 2022 - Okt. 2022',
          highlights: [
            'OOP mit C#: Entwicklung objektorientierter Programme mit Klassen, Methoden, Polymorphismus',
            'Mobile Entwicklung mit Xamarin: UI-Design, Eventhandling und Modell-Implementierung',
            'Analysetool für Rechnungen: UML-Diagramme, C#-Implementierung, Excel-Verarbeitung',
          ],
        },
      ],
    },
  ...
  en: {
    ...
    experience: {
      ...
      jobs: [
        ...
        {
          company: 'Sparkassenversicherung',
          role: 'Working Student – Python Dev',
          location: 'Mannheim',
          period: 'Feb 2023 - May 2024',
          highlights: [
            'Development of graphical (GUI) user interfaces, automation and test case generation with Tkinter and CustomTkinter',
            'Data processing and analysis with Pandas and database integration with Oracle SQL Developer',
            'Creation and execution of unit tests to ensure functionality and reliability',
            'Use of Gitea, Eclipse, Docker, Podman and Oracle Developer',
          ],
        },
        {
          company: 'Engenious',
          role: 'Working Student – Mobile Dev',
          location: 'Brühl',
          period: 'May 2022 - Oct 2022',
          highlights: [
            'OOP with C#: Development of object-oriented programs with classes, methods, polymorphism',
            'Mobile development with Xamarin: UI design, event handling and model implementation',
            'Invoice analysis tool: UML diagrams, C# implementation, Excel processing interface',
          ],
        },
      ],
    },
